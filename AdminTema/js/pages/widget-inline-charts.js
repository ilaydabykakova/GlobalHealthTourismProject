...
$(function () {
	...
	$("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#389af0', '#26dad2', '#5c4ac7', '#ef5350'],
  ...
  function drawDocSparklines() {
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineColor: '#ef5350', fillColor: '#ffb22b',
          minSpotColor: false, maxSpotColor: false, spotColor: '#5c4ac7', spotRadius: 3
        });
    ...
    $('#discrete2').sparkline('html',
        {type: 'discrete', lineColor: '#389af0', thresholdColor: '#ef5350', thresholdValue: 4});
